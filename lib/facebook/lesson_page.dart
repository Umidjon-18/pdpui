...
class FacebookLessonPage extends StatefulWidget {
  const FacebookLessonPage({Key? key}) : super(key: key);
  static const id = 'facebook_lesson_page';

  @override
  State<FacebookLessonPage> createState() => _FacebookLessonPageState();
}

class _FacebookLessonPageState extends State<FacebookLessonPage> {
  @override
      ...
      body: ListView(
        children: [
          ...
          makeFeed(
            ...
            feedImage: 'assets/images/facebook_images/feed_5.jpeg',
          ),
          makeFeed(
            userName: 'John',
            userImage: 'assets/images/facebook_images/user_2.jpeg',
            ...
            feedText:
                'Loreim ipsum text from the internet, it is just text for creating an app UI',
            feedImage: 'assets/images/facebook_images/feed_4.jpeg',
          ),
          makeFeed(
            userName: 'Lisa',
            userImage: 'assets/images/facebook_images/user_1.jpeg',
            ...
            feedText:
                'Loreim ipsum text from the internet, it is just text for creating an app UI',
            feedImage: 'assets/images/facebook_images/feed_1.jpeg',
          ),
          makeFeed(
            userName: 'Devid',
            userImage: 'assets/images/facebook_images/user_4.jpeg',
            ...
            feedText:
                'Loreim ipsum text from the internet, it is just text for creating an app UI',
            feedImage: 'assets/images/facebook_images/feed_2.jpeg',
          ),
          makeFeed(
            userName: 'Alisa',
            userImage: 'assets/images/facebook_images/user_5.jpeg',
            ...
            feedText:
                'Loreim ipsum text from the internet, it is just text for creating an app UI',
            feedImage: 'assets/images/facebook_images/feed_3.jpeg',
          ),
        ],
      ),
    );
