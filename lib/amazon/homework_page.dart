...
class AmazonHomeworkPage extends StatefulWidget {
  const AmazonHomeworkPage({Key? key}) : super(key: key);
  static const id = 'amazon_homework_page';

  @override
  State<AmazonHomeworkPage> createState() => _AmazonHomeworkPageState();
}

class _AmazonHomeworkPageState extends State<AmazonHomeworkPage> {
  @override
